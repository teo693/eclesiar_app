...
from config import AUTH_TOKEN, GOLD_ID_FALLBACK, MIN_PROFIT_THRESHOLD, API_WORKERS_MARKET
from api_client import fetch_data
from economy import fetch_countries_and_currencies, build_currency_rates_map
